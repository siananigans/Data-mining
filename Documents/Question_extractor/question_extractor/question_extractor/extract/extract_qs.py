...
class Question_Sentence:
    ...
    def wh_finder(self, entity_lst):
        ...
        language_model = open(os.path.join(settings.BASE_DIR, 'question_extractor/extract/models/language_model'), 'rb')
        language_model = pickle.load(language_model)
        # Location model to detect locations
        location_model = open(os.path.join(settings.BASE_DIR, 'question_extractor/extract/models/location_model'), 'rb')
