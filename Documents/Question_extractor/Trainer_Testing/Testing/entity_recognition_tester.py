...
def get_question(sents_dict):
    ...
    print("Percentagee of correct sentences " + str(score))


def main():
    test_sents = {'This is a sentence to test the entity recognition.': 'entity recognition what', 'Ireland is a place in the world.': 'Ireland Where',
