...
def cluster():
	...
	centroids = [['L6', 'Found', 1980, -95.00, 50 ],['L6', 'Fell', 2000, 40, 0 ],['H4', 'Found', 1975, -51.00, 23.00], ['L6', 'Found', 1877, 28.00, -8.00]]
	...
	with open('./results.txt', mode='a') as results:
		results.write("\n--------------------------------------------------------")
		results.write("\nResults for Clustering dataset where k = " + str(k)+". And Mass attribute discounted.\n")
		results.write("----------------------------------------------------------\n")
